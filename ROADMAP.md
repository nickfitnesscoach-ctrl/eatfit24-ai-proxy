...
- [x] Ограничить доступ (Tailscale / firewall + API key).
- [x] Добавить базовое логирование ошибок.
- [x] Подготовить короткую API-доку для Django-бэкенда.

## Phase 4 — Optimization (ТЕКУЩАЯ)
